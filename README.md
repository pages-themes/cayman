...
color-scheme: ["dark", "light", "auto" or "auto-default-dark" auto is default setting and changes theme based on device theme, auto-deafualt-dark is the same except if you device does not support changing theme based on device theme it will default to dark and the others are fairly explanetory.]
```
